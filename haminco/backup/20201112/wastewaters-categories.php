...
<body class="body-site body-page body-wastewaters-categories">
	...
	<main class="main-page">
		<div class="main-container">
			<div class="main-content">
				...
				<article class="art-categories art-wastewaters-categories">
					<div class="container">
						<div class="row">
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
											...
											<div class="item">
												<div class="category-box">
													<div class="category-image">
														<div class="image">
															<a href="wastewaters.php" title="Category">
																<img src="assets/images/wa-cat-04.jpg" alt="Category">
															</a>
														</div>
													</div>
											...
											<div class="item">
												<div class="category-box">
													<div class="category-image">
														<div class="image">
															<a href="wastewaters.php" title="Category">
																<img src="assets/images/wa-cat-05.jpg" alt="Category">
															</a>
														</div>
													</div>
