...
jQuery(document).ready(function($) {
    $('.lth-product-tabs .detailed-review .btn-read-more').click(function(e){
        e.preventDefault();
        $('.lth-product-tabs .detailed-review .content').height('auto');
        $(this).hide();
    });

    $(document).on('click', '.lth-product-tabs .module__header .tabs-menu .title', function (e) {
        e.preventDefault();
