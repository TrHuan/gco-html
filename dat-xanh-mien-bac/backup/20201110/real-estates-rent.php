...
<body class="body-site body-page body-real-estates-rent">
							...
							<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12">
								<div class="posts-box blogs-box">
									<div class="title-box posts-title">
										<h3 class="title">Danh sách bất động sản cho thuê</h3>
									</div>

									<div class="content-box posts-content">
										<div class="contents blogs-list">
											<?php include 'templates/addons/real-estates-rent.php'; ?>
										</div>
