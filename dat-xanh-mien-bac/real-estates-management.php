...
<body class="body-site body-page body-real-estates-management">
	...
	<main class="main-page">
		<div class="main-container">
			<div class="main-content">
				...
				<article class="art-posts art-real-estates-management">
					<div class="container">
						<div class="row">
							<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12">
								<div class="posts-box blogs-box">
									<div class="title-box posts-title">
										<h3 class="title">Quản lý bất động sản</h3>
									</div>

									<div class="content-box posts-content">
										<div class="contents blogs-list">
											<?php include 'templates/addons/real-estates-management-box.php'; ?>
										</div>
