...
jQuery(document).ready(function($) {
    ...
    $(".slick-brands").slick({
        ...
        slidesToScroll: 1,
        adaptiveHeight: true,
        prevArrow: '<button class="slick-arrow slick-prev" href="javascript:0"><i class="fas fa-caret-left icon"></i></button>',
        nextArrow: '<button class="slick-arrow slick-next" href="javascript:0"><i class="fas fa-caret-right icon"></i></button>',
        responsive: [
            {
                breakpoint: 1200,
                settings: {
...
jQuery(document).ready(function($) {
    $('.address-box .title-box .form-control').click(function(){
        var x = $(this).val();

        $('.address-content ul').removeClass('active');
        $('.address-content ul.' + x).addClass('active');
    });

    $('.art-videos .banner-content a').click(function(e){
        e.preventDefault();
