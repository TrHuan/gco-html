					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="content">
							<div class="advanced-search-block">
								<form class="advanced-search-form withdrawal-search-form">
									<input type="text" name="search" class="search-input" placeholder="Danh sách tài khoản muốn rút về">
									<input type="text" name="search" class="search-input" placeholder="Nhập số tiền có thể rút">
									<button class="btn search-btn">
										<span>Tìm kiếm</span>
									</button>
								</form>
								...
								<div class="table-content">
									<table>
									  <tr class="title-table">
									    ...
									    <th class="center">Danh sách đơn rút tiền</th>
									  ...
									  <tr class="content-table">
									    ...
									    <td class="center">Đã rút tiền</td>
									    <td class="center">Ngày 20/06/2020</td>
									    <td class="center">Lorem Ipsum is simply dummy</td>
									  </tr>
									  <tr class="content-table">
