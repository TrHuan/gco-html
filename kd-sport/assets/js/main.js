...
jQuery(document).ready(function($) {
    ...
    $('.content-sidebar .sub-title span').click(function(e){
        e.preventDefault();

        var asc = $(this).parent().hasClass('active');

        if (asc) {
            $(this).parent().removeClass('active');
            $(this).parent().next().slideUp('slow');
        } else {
            $('.content-sidebar .sub-title').removeClass('active');
            $('.content-sidebar .sub-menu').slideUp('slow');
