			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="breadcrumbs-content">
					<div class="image-box breadcrumb-image">
						<img src="assets/images/bg-breadcrumb-5.jpg" alt="Breadcrumb">
					</div>
				</div>				
			</div>
		</div>
...
<main class="main-site page-site catalogues-site main-margin-bottom">
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="main-container">
									...
									<div class="breadcrumbs-content">
										<div class="content-box content-breadcrumb">
											<ul class="breadcrumb-box">
												...
												<li>
													<a href="certificates.php" title="Năng lực sản xuất">Năng lực sản xuất</a>
												</li>
												<li>
													<span>Catalogue</span>
												</li>
					...
					<article class="art-catalogues">
						<div class="container">
							<div class="row">
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="art-catalogues">
										<div class="catalogues-box">
											<div class="post-description-title">
												<h1 class="title"><span>catalogue</span></h1>
											...
											<div class="post-description-content">
												<div class="content">
													...
													<img src="assets/images/cata-d-01.jpg" alt="Blog detail">
													...
													<p class="link-download">Link tải catalogue: <a href="#" download title="Download">Tại đây</a></p>
												</div>		
											</div>		
										</div>
									</div>
								...
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="blogs-related-box">
										...
										<div class="blogs-related-content">
											<ul>
												<li>
													<a href="#" title="Link">Hình ảnh nhà máy sản xuất</a>
												</li>
												<li>
													<a href="#" title="Link">Hình ảnh công trường</a>
												</li>
												<li>
													<a href="#" title="Link">catalogue</a>
												</li>
											</ul>
										</div>
									</div>
