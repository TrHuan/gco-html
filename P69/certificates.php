...
<main class="main-site page-site certificates-site main-margin-bottom">
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="main-container">
									...
									<div class="breadcrumbs-content">
										<div class="content-box content-breadcrumb">
											<ul class="breadcrumb-box">
												...
												<li>
													<span>Chứng chỉ chứng nhận</span>
												</li>
											</ul>
										</div>
									</div>
					...
					<article class="art-certificates">
						<div class="container">
							<div class="row">
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="art-certificates">
										<div class="certificates-box">
											<div class="post-description-title">
												<h1 class="title"><span>Chứng chỉ chứng nhận</span></h1>
											...
											<div class="post-description-content">
												<div class="content">
													...
													<img src="assets/images/cc-d-01.jpg" alt="Blog detail">
